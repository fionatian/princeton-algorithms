...
public class Point implements Comparable<Point> {
     ...
     * are (x0, y0) and (x1, y1), then the slope * is (y1 - y0) / (x1 - x0). For completeness, the
     * slope is defined to be +0.0 if the line segment connecting the two points is horizontal;
    ...
    public double slopeTo(Point that) {
        ...
        else return (double) (y - that.y) / (x - that.x);
    }
